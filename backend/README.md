...
## Project Structure
    ...
    ├── testapiautodatamod_105162  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_105162`
...
2. Clone this repo and `cd testapiautodatamod_105162`
